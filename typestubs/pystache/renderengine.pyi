...
class RenderEngine:
    ...
    """
    def __init__(self, literal=..., escape=..., resolve_context=..., resolve_partial=..., to_str=...) -> None:
        """
        Arguments:
    ...
    def fetch_section_data(self, context, name): # -> list[Unknown | dict[Unknown, Unknown]] | list[Unknown]:
        """
